...
# Use sklearn logistic regression to do classification of sentiments
from sklearn.linear_model import LogisticRegression
from sklearn.metrics import confusion_matrix


# two options: pre-trained global-vector or self-trained wordvectors cbow
def getArguments():
...
def getSentenceFeatures(tokens, wordVectors, sentence):
    ...
    word vectors
    """
    # Computation for the sentence features given a sentence.
...
def chooseBestModel(results):
    ...
    Returns:Chosen result dictionary.
    """
    bestResult = None
...
def plotRegVsAccuracy(regValues, results, filename):
    ...
    plt.plot(regValues, [x["train"] for x in results], color = 'teal')
    plt.plot(regValues, [x["dev"] for x in results], color = 'palevioletred')
    plt.xscale('log')
    plt.xlabel("regularization")
    plt.title("Regularization and Accuracy")
    plt.ylabel("accuracy")
